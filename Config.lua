...
DF.PartyDefaults = {
    ...
    personalTargetedSpellImportantBorderAnimationType = "DF_DASH",
    ...
    targetedSpellImportantBorderAnimationFrequency = 0.5,
    ...
    targetedSpellImportantBorderAnimationType = "DF_DASH",
